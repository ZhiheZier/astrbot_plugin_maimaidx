...
**水鱼查分器（Diving-Fish）**
- `maimaidxtoken`: 水鱼查分器开发者 token。填写后支持 AP50、AP+50、星级 B50、拟合定数 50 等完整成绩查询；未填写时仅可使用 `b50` 等公开查询指令
...
### 成绩查询
- `b50 <QQ号>` - 查询 Best 50
- `ap50 <QQ号>` - 从玩家实际 AP / AP+ 成绩中查询旧曲 35 + 新曲 15
- `ap+50` / `理论b50` - 从玩家实际 AP+ 成绩中查询旧曲 35 + 新曲 15
